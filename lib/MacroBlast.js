...
function createShip(){
  ...
  ship.addAnimation('thrust', 'media/Macro_Cells/Player_Cell.png', 'media/Macro_Cells/Player_Cell2.png', 'media/Macro_Cells/Player_Cell2.png', 'media/Macro_Cells/Player_Cell2.png');
}
...
if(KillPoints%killStreak*lifes==0&&KillPoints>0){killStreak++;
KillPoints=0;}
